...
description: "PK: NOTIF#{id}, SK: METADATA. GSIs: RecipientIndex, StatusIndex, IdempotencyIndex. On-demand capacity, 90-day TTL"
technology: "DynamoDB"
tags:
  - "database"
  - "notifications"
...
PK: NOTIF#{id}, SK: METADATA. GSIs: RecipientIndex, StatusIndex, IdempotencyIndex. On-demand capacity, 90-day TTL
...
This component is responsible for PK: NOTIF#{id}, SK: METADATA. GSIs: RecipientIndex, StatusIndex, IdempotencyIndex. On-demand capacity, 90-day TTL.
