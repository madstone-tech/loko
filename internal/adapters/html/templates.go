						...
						{{end}}
							...
							<div class="components-list">
								...
								<ul>
									{{range .Components}}
									<li>
										<a href="../components/{{.ID}}.html" class="component-link"><strong>{{.Name}}</strong></a>
	...
	<div class="container">
		...
		<main class="main-content">
			...
			<section class="relationships-section">
				<h2>Dependencies</h2>
				<p class="section-description">This component depends on the following components:</p>
				<div class="relationships-list">
					{{range $id, $desc := .Component.Relationships}}
					<div class="relationship-item">
						<h4>{{$id}}</h4>
						{{if $desc}}
						<p class="relationship-description">{{$desc}}</p>
						{{end}}
					</div>
					{{end}}
				</div>
			...
			{{if .Component.CodeAnnotations}}
			<section class="code-annotations-section">
				<h2>Code Annotations</h2>
				<p class="section-description">Key code locations and their responsibilities:</p>
				<div class="code-annotations-list">
					{{range $path, $desc := .Component.CodeAnnotations}}
					<div class="code-annotation-item">
						<code class="code-path">{{$path}}</code>
						{{if $desc}}
						<p class="annotation-description">{{$desc}}</p>
						{{end}}
					</div>
					{{end}}
				</div>
			...
			<section class="external-deps-section">
				<h2>External Dependencies</h2>
				<p class="section-description">External packages and libraries this component depends on:</p>
				<ul class="external-deps-list">
					{{range .Component.Dependencies}}
					<li><code>{{.}}</code></li>
					{{end}}
				</ul>
			</section>
